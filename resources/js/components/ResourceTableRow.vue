    ...
    >
      <div class="flex items-center space-x-0 text-gray-400">
        ...
        <button
          ...
          class="appearance-none cursor-pointer text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 focus:text-gray-500 active:text-gray-600 mr-3 focus:outline-none"
